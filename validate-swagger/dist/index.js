...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield utils.downloadFile(schemaUrl, swaggerSchemaFile);
        yield exec.exec(`vc-build ValidateSwaggerSchema -SwaggerSchemaPath ${swaggerSchemaFile} -SwaggerValidatorUri ${validatorUrl}`);
    });
}
