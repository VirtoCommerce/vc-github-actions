...
import { Octokit } from '@actions/github/lib/node_modules/@octokit/core';
...
export declare const GitHub: (new (...args: any[]) => {
    ...
    paginate: import("@actions/github/lib/node_modules/@octokit/plugin-paginate-rest").PaginateInterface;
}>;
/**
