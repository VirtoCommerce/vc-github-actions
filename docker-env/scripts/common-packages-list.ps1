...
$packages["VirtoCommerce.Quote"] = "VirtoCommerce.Quote$($($edgePackages | Where-Object { $_.Id -eq 'VirtoCommerce.Quote' } | Select-Object -ExpandProperty Versions)[0].Version).zip"
