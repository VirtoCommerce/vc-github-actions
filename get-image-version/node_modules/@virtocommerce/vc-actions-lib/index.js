            ...
            if (!err) {
                xml2js.parseString(data, function (err, json) {
                    if (!err) {
                        ...
                        let moduleDescription = json.module.description[0];
                        let projectUrl = json.module.projectUrl[0];
                        let iconUrl = json.module.iconUrl[0];
                        let prefix = json.module.version[0].trim();
                        let suffix = "";
                        if(json.module["version-tag"] !== undefined)
