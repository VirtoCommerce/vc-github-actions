        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    downloadUrl = blobUrl + "/" + artifactFileName;
                    console.log("Download url: " + downloadUrl);
                    core.setOutput("blobUrl", downloadUrl);
                    return [4, exec.exec("azcopy10 copy " + artifactPath + " " + blobUrlWithSAS, [], { ignoreReturnCode: true, failOnStdErr: false }).catch(function (reason) {
                            console.log(reason);
                            process.exit(1);
